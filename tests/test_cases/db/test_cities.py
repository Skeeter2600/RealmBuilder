...
class MyTestCase(unittest.TestCase):
    ...
    def test_add_city(self):
        ...
        outcome = add_city(ryan_r_info['user_id'], ryan_r_info['session_key'], details)
        self.assertFalse(outcome['session_key'], "created city when is should not have")

        outcome = add_city(ryan_c_info['user_id'], ryan_c_info['session_key'], details)
        self.assertTrue(outcome['session_key'], "did not create city properly")
        ...
        outcome = get_city(ryan_r_info['user_id'], ryan_r_info['session_key'], city_id, False)
        ...
        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], city_id, True)
        ...
        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], city_id, False)
        # test each field is right for as an admin
        # (done this way due to timestamp in the creation changing each time)
    ...
    def test_copy_city(self):
        ...
        outcome = copy_city(ryan_r_info['user_id'], ryan_r_info['session_key'], 4, 2)['results']
        self.assertFalse(outcome, "Should not have been successful")

        outcome = copy_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 4, 2)
        self.assertTrue(outcome['session_key'], "Should have been successful")

        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 4, True)
    ...
    def test_delete_city(self):
        ...
        outcome = delete_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 1, 3)
        self.assertFalse(outcome, "Should not be able to delete city")
        outcome = delete_city(beck_info['user_id'], beck_info['session_key'], 1, 3)
        self.assertTrue(outcome, "Should be able to delete city")

        check_city_exists = get_city(beck_info['user_id'], beck_info['session_key'], 1, True)
    ...
    def test_edit_city(self):
        ...
        outcome = edit_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 4, 6, edit_values)
        self.assertEqual(outcome['name'], '', "should not have edited any info")
        outcome = edit_city(ryan_r_info['user_id'], ryan_r_info['session_key'], 4, 6, edit_values)
        ...
        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 4, False)
        self.assertEqual(edit_values['name'], outcome['name'], "did not get the city properly")
        self.assertEqual(edit_values['population'], outcome['population'], "did not get the city properly")
        self.assertEqual(edit_values['song'], outcome['song'], "did not get the city properly")
        self.assertEqual(edit_values['trades'], outcome['trades'], "did not get the city properly")
    ...
    def test_get_city(self):
        ...
        outcome = get_city(ryan_r_info['user_id'], ryan_r_info['session_key'], 4, True)
        self.assertEqual("Jamestown", outcome['name'], "not the right city name")
        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 4, False)
        self.assertEqual("Jamestown", outcome['name'], "not the right city name")

        # should get Greenest for both
        outcome = get_city(ryan_c_info['user_id'], ryan_c_info['session_key'], 2, True)
        self.assertEqual("Greenest", outcome['name'], "not the right city name")
        outcome = get_city(ryan_r_info['user_id'], ryan_r_info['session_key'], 2, False)
    ...
    def test_get_cities(self):
        ...
        outcome = get_cities(beck_info['user_id'], beck_info['session_key'], 3, None, 1)
        ...
        outcome = get_cities(charles_info['user_id'], charles_info['session_key'], 3, None, 1)
    ...
    def test_search_cities(self):
        ...
        outcome = search_for_city('Meridia', 3, None, 1, beck_info['user_id'], beck_info['session_key'])
        ...
        outcome = search_for_city('Meridia', 3, None, 1, charles_info['user_id'], charles_info['session_key'])
        self.assertEqual([{'id': 5, 'name': 'Meridia', 'population': 1392}], outcome, "not the right cities")

        outcome = search_for_city('e', 3, None, 1, beck_info['user_id'], beck_info['session_key'])
        self.assertEqual(len(outcome), 3, "not the right number of cities")

        outcome = search_for_city('e', 3, None, 1, charles_info['user_id'], charles_info['session_key'])
    ...
    def test_get_npcs_in_city(self):
        ...
        outcome = get_npcs_by_city(beck_info['user_id'], beck_info['session_key'], 5)
        ...
        outcome = get_npcs_by_city(charles_info['user_id'], charles_info['session_key'], 5)
        ...
        outcome = get_npcs_by_city(beck_info['user_id'], beck_info['session_key'], 3)
        ...
        outcome = get_npcs_by_city(charles_info['user_id'], charles_info['session_key'], 3)
    ...
    def test_get_specials_in_city(self):
        ...
        outcome = get_specials_by_city(beck_info['user_id'], beck_info['session_key'], 5)
        ...
        outcome = get_specials_by_city(charles_info['user_id'], charles_info['session_key'], 5)
